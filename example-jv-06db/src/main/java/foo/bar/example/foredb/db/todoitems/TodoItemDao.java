...
import static foo.bar.example.foredb.db.todoitems.TodoItemEntity.COLUMN_CREATE_TIMESTAMP;
import static foo.bar.example.foredb.db.todoitems.TodoItemEntity.COLUMN_DONE;
