...
Retrofit, Apollo and Ktor all use OkHttp under the hood (for Ktor it's optional) and this enables **fore** to handle their networking calls in a very similar way: by wrapping them with a **CallWrapper** class ([CallWrapperRetrofit2](https://github.com/erdo/android-fore/blob/master/fore-kt/fore-kt-android-network/src/main/java/co/early/fore/kt/net/retrofit2/CallWrapperRetrofit2.kt) \| [CallWrapperApollo3](https://github.com/erdo/android-fore/blob/master/fore-kt/fore-kt-network/src/main/java/co/early/fore/kt/net/apollo3/CallWrapperApollo3.kt) \| [CallWrapperKtorX](https://github.com/erdo/android-fore/blob/master/fore-kt/fore-kt-network/src/main/java/co/early/fore/kt/net/ktor/CallWrapperKtor.kt)). For usage examples, please see the appropriate example apps in the repo.
