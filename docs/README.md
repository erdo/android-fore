...
![central-1.5.17](https://img.shields.io/badge/central-1.5.17-green.svg){: .float-left}
...
```
implementation("co.early.fore:fore-kt-android:1.5.17")
```
...
```
implementation("co.early.fore:fore-kt-android-compose:1.2.0")
```
