...
![central-1.5.0](https://img.shields.io/badge/central-1.5.0-green.svg){: .float-left}
...
```
implementation("co.early.fore:fore-kt-android:1.5.0")
```

the legacy **java** API:
```
implementation("co.early.fore:fore-jv-android:1.5.0")
```
