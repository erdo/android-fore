...
![central-1.4.0](https://img.shields.io/badge/central-1.4.0-green.svg){: .float-left}
...
```
implementation "co.early.fore:fore-kt:1.4.0"
```

the original **java** API:
```
implementation "co.early.fore:fore-jv:1.4.0"
```
