...
![central-1.5.23](https://img.shields.io/badge/central-1.5.23-green.svg){: .float-left}
...
```
implementation("co.early.fore:fore-kt-android:1.5.23")
```
...
```
implementation("co.early.fore:fore-kt-android-compose:1.4.2")
```
