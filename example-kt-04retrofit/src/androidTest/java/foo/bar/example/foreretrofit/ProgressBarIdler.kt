...
class ProgressBarIdler : Application.ActivityLifecycleCallbacks {
    ...
    override fun onActivityResumed(activity: Activity) {
        makeAllProgressBarsIdle(activity.findViewById<View>(android.R.id.content).rootView)
    }
    ...
    companion object {
        ...
        fun makeAllProgressBarsIdle(instrumentation: Instrumentation, activity: Activity) {
            instrumentation.runOnMainSync { makeAllProgressBarsIdle(activity.findViewById<View>(android.R.id.content).rootView) }
        }
