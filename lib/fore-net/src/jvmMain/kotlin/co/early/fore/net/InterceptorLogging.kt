...
//    private val curlStyleRequestLogging: Boolean = true,
//) : Interceptor {
//
...
//            logHeaders(it.sanitizeHeaders(headers(request)), randomPostTag, curlStyle = curlStyleRequestLogging)
//        } ?: logHeaders(headers(request), randomPostTag, curlStyle = curlStyleRequestLogging)
//
//        body(request)?.let {
//
//            val buffer = Buffer()
...
//                        150
//                    )
//                    logLines(wrappedLines, randomPostTag, curlStyle = curlStyleRequestLogging)
