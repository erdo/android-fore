...
/**
 * @param <F> Failure message class to be used throughout the app, such as a sealed class
 * or an enum
 */
interface ErrorHandler<F> {
     ...
     * @param errorResponse response from the server, the body of which may represent custom
     * error(s), may be null
