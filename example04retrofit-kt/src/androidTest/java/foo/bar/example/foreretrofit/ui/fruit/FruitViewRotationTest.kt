...
class FruitViewRotationTest {
    ...
    private lateinit var cachedSuccess: co.early.fore.core.callbacks.SuccessWithPayload<ArrayList<FruitPojo>>
    ...
    fun setCachedSuccessCallback(success: co.early.fore.core.callbacks.SuccessWithPayload<ArrayList<FruitPojo>>) {
