...
class FruitView @JvmOverloads constructor(
    ...
    private val success: co.early.fore.core.callbacks.Success = {
        Toast.makeText(
    ...
    private val failureWithPayload: co.early.fore.core.callbacks.FailureWithPayload<UserMessage> = { userMessage ->
        Toast.makeText(
