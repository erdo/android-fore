 ...
 *      instead of extending RelativeLayout, extend this class instead.
 * </p>
 *
 * <p>
 ...
 *
 */
public abstract class SyncRelativeLayout extends RelativeLayout implements SyncableView {

    private LifecycleSyncer lifecycleSyncer;

    public SyncRelativeLayout(Context context) {
        super(context);
    }
    ...
    public SyncRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
