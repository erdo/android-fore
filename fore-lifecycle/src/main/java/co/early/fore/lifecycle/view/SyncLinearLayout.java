 ...
 *      instead of extending LinearLayout, extend this class instead.
 * </p>
 *
 * <p>
 ...
 *
 */
public abstract class SyncLinearLayout extends LinearLayout implements SyncableView {
    ...
    public SyncLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
