 ...
 *      instead of extending androidx CoordinatorLayout, extend this class instead.
 * </p>
 *
 * <p>
 ...
 *
 */
public abstract class SyncCoordinatorLayout extends CoordinatorLayout implements SyncableView {

    private LifecycleSyncer lifecycleSyncer;

    public SyncCoordinatorLayout(Context context) {
        super(context);
    }

    public SyncCoordinatorLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SyncCoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
