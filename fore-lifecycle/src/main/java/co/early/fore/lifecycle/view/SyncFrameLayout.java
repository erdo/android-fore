 ...
 *      instead of extending FrameLayout, extend this class instead.
 * </p>
 *
 * <p>
 ...
 *
 */
public abstract class SyncFrameLayout extends FrameLayout implements SyncableView {

    private LifecycleSyncer lifecycleSyncer;

    public SyncFrameLayout(Context context) {
        super(context);
    }

    public SyncFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SyncFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
