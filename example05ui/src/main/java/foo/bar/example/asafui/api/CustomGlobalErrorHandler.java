package foo.bar.example.asafui.api;
...
import static foo.bar.example.asafui.message.UserMessage.ERROR_CLIENT;
import static foo.bar.example.asafui.message.UserMessage.ERROR_MISC;
import static foo.bar.example.asafui.message.UserMessage.ERROR_NETWORK;
import static foo.bar.example.asafui.message.UserMessage.ERROR_SERVER;
import static foo.bar.example.asafui.message.UserMessage.ERROR_SESSION_TIMED_OUT;
