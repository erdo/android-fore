 ...
 *
 */
public class FruitCollectorView extends ConstraintLayout implements SyncableView{
    ...
    private FruitCollectorAdapter adapterAdvanced;



    public FruitCollectorView(Context context) {
        super(context);
    }

    public FruitCollectorView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FruitCollectorView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public FruitCollectorView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void setupAdapters(){
        ...
        adapterAdvanced = new FruitCollectorAdapter(playlistAdvancedModel);
