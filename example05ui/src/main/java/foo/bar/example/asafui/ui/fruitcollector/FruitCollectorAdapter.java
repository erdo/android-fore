 ...
 *
 */
public class FruitCollectorAdapter extends SimpleChangeAwareAdapter<FruitCollectorAdapter.ViewHolder> {

    private static final String TAG = FruitCollectorAdapter.class.getSimpleName();

    private final PlaylistAdvancedModel playlistAdvancedModel;

    public FruitCollectorAdapter(final PlaylistAdvancedModel playlistAdvancedModel) {
