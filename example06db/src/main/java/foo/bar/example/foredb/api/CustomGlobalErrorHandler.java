...
import static foo.bar.example.foredb.message.UserMessage.ERROR_CLIENT;
import static foo.bar.example.foredb.message.UserMessage.ERROR_MISC;
import static foo.bar.example.foredb.message.UserMessage.ERROR_NETWORK;
import static foo.bar.example.foredb.message.UserMessage.ERROR_SERVER;
import static foo.bar.example.foredb.message.UserMessage.ERROR_SESSION_TIMED_OUT;
