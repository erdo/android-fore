...
object Shared {
    ...
    object Versions {
        ...
        const val kotlin_version = "1.8.10" // must manually change buildSrc.build version
    ...
    object Publish {
        const val LIB_VERSION_NAME = "1.5.22" //"x.x.x-SNAPSHOT"
        const val LIB_VERSION_CODE = 89
        ...
        const val published_fore_version_for_examples = "1.5.22"
    }
