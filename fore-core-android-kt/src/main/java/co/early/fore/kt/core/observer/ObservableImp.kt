            ...
            if (Looper.myLooper() != Looper.getMainLooper()) {
                ForeDelegateHolder.getLogger(logger).e(
                        "NOTE: this code is NOT currently on the UI thread,\n" +
                                ...
                                "You can achieve this by either a) calling notifyObservers() from the UI thread,\n" +
                                ...
                                "\n" +
                                "If you are updating list based data for an Android Adapter directly with these notifications,\n" +
