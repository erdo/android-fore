...
//    suspend fun getFruitsSimulateOk(@Query("mocky-delay") delay: String = "3s"): Response<List<Launch>>
//
//    @GET("59ef2a6c2e00002a1a1c5dea/")
//    suspend fun getFruitsSimulateNotAuthorised(@Query("mocky-delay") delay: String = "3s"): Response<List<Launch>>
//
...
//
//    @GET("59efa0132e0000ef331c5f9b/")
//    suspend fun claimFreeFruit(@Query("ticketRef") ticketRef: String, @Query("mocky-delay") delay: String = "1s"): Response<List<Launch>>
