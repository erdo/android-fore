...
dependencies {
    ...
    if (Shared.Publish.use_published_version) {
        implementation("co.early.fore:fore-jv-android-adapters:${Shared.Publish.published_fore_version_for_examples}")
    } else {
        implementation(project(":fore-jv:fore-jv-android-adapters"))
    }
